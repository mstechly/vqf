...
def factor_number(m, true_p, true_q, use_true_values=True):
    ...
    optimization_engine = OptimizationEngine(clauses, m, steps=1, grid_size=30, gate_noise=1e-3, verbose=optimization_verbose, visualize=True)
